  ...
  <section class="w-100">
    <div class="card bg-dark text-white w-100 z-0">
      ...
      <div class="card-img-overlay text-light justify-content-center flex-column text-center pt-0 pt-lg-5" style="background-color: rgba(0, 0, 0, 0.5)">
        <h2 class="fs-1 pt-4 pt-lg-5"> ¡Bienvenido!</h2>
      </div>
    </div>
  </section>
  <div id="cartas" class="card-group container-lg z-1 ">
      <div class="card">
    ...
    <div id="footerino" class="container-fluid">
      <div class="row justify-content-md-center pb-lg-5 pb-5 pt-5 m-0 text-white">
          ...
          <div class="d-flex col-lg-5 mt-5 justify-content-center">
            <p div class="h7 text-center">Complejo Cultural Siglo XXI | Todos los derechos reservados © 2023
            </p>
          </div>

        <div class="d-flex mt-5 col-lg-3 align-middle justify-content-evenly">
        ...
        <div class="d-flex mt-5 col-lg-3 justify-content-center">
          <a class="ms-2 me-3" href="https://www.facebook.com/CCUBUAP/?locale=es_LA" style="text-decoration:none">
          ...
          <a class="ms-2 me-3" href="https://twitter.com/i/flow/login?redirect_after_login=%2Fccubuap%3Flang%3Des" style="text-decoration:none">
          ...
          <a class="ms-2 me-3" href="https://www.youtube.com/watch?v=QWm4wYidIoY" style="text-decoration:none">
